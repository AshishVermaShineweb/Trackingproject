        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block table-border-style">
                    <form action="{{ url('/company/project/create') }}" method="POST">
                        @csrf
                        <div class="row mb-1">
                            <div class="col">
                                <label>Project Name</label>
                                <input type="text" placeholder="Project Name" class="form-control" name="project-name" value="{{ old('project-name') }}">
                            ...
                            <div class="col">
                                ...
                                <input type="number" placeholder="Hour Limit" class="form-control" name="hourLimit"   value="40" min="40" max="60" id="hour-limit">
...
<script>
    $("#hour-limit").on("keypress",function(){
        alert();

        triggerAlert('Only use icon for increase or decrease',"warning");
        return false;
            });
