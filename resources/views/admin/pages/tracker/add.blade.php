        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block table-border-style">
                    <form action="{{ url('/company/users/create') }}" method="POST">
                        @csrf
                        <div class="row mb-1">
                            <div class="col">
                                <label>Name</label>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="timezone" id="" placeholder="Timezone" class="form-control">
                                @if($errors->has("timezone"))
                                <p class="text-danger"><i class="fa fa-warning"></i> {{ $errors->first("timezone") }}</p>
                                @endif
                            </div>
                        </div>
                        <div class="row">
