            ...
            <tr>
                ...
                <td>
                    ...
                    <span class="badge rounded-pill badge-light-success" text-capitalized="">Active</span>
                        @else
                        <span class="badge rounded-pill badge-light-danger" text-capitalized="">Deactive</span>
                    @endif
